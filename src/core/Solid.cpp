...
std::vector<std::shared_ptr<BoxCollider>> Solid::walls = {
    ...
    std::make_shared<BoxCollider>(glm::vec2(845, 263), glm::vec2(10, 538)), // right top
    ...
    std::make_shared<BoxCollider>(glm::vec2(-870, 263), glm::vec2(63, 538)), // left top
    std::make_shared<BoxCollider>(glm::vec2(-485, 425), glm::vec2(830, 100)), // top left
    std::make_shared<BoxCollider>(glm::vec2(440, 425), glm::vec2(770, 100)) // top right
};
